...
class CategoryKeywordRepositoryImplTest {
    ...
    @Test
    fun `getAllKeywords should return all keywords`() =
        runBlocking {
            val entities =
                listOf(
    ...
    @Test
    fun `getKeywordsByCategory should return keywords for specific category`() =
        runBlocking {
            val entities =
                listOf(
                    CategoryKeywordEntity(1, 1, "restaurant"),
    ...
    @Test
    fun `addKeyword should normalize and save keyword`() =
        runBlocking {
    ...
    fun `addKeyword should throw exception for empty keyword`(): Unit =
        runBlocking {
            repository.addKeyword(1, "   ")
        }

    @Test
    fun `addKeywords should normalize and save multiple keywords`() =
        runBlocking {
    ...
    @Test
    fun `addKeywords should filter blank keywords and remove duplicates`() =
        runBlocking {
            coEvery { dao.insertAll(any()) } returns Unit
    ...
    @Test
    fun `predictCategory should return null for blank text`() =
        runBlocking {
    ...
    @Test
    fun `predictCategory should return categoryId for matching keyword`() =
        runBlocking {
            val entities =
                listOf(
                    CategoryKeywordEntity(1, 1, "restaurant"),
    ...
    @Test
    fun `predictCategory should be case insensitive`() =
        runBlocking {
            val entities =
                listOf(
                    CategoryKeywordEntity(1, 1, "restaurant")
    ...
    @Test
    fun `predictCategory should prioritize longer keywords`() =
        runBlocking {
            val entities =
                listOf(
    ...
    @Test
    fun `predictCategory should return null for no matches`() =
        runBlocking {
            val entities =
                listOf(
                    CategoryKeywordEntity(1, 1, "restaurant")
    ...
    @Test
    fun `predictCategory should match partial words`() =
        runBlocking {
            val entities =
                listOf(
    ...
    @Test
    fun `deleteKeyword should call dao deleteById`() =
        runBlocking {
    ...
    @Test
    fun `deleteKeywordsByCategory should call dao deleteByCategory`() =
        runBlocking {
