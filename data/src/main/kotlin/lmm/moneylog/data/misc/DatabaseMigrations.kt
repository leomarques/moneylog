...
val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE INDEX IF NOT EXISTS `index_transaction_new_accountId` ON `transaction_new` (`accountId`)")
        database.execSQL("CREATE INDEX IF NOT EXISTS `index_transaction_new_categoryId` ON `transaction_new` (`categoryId`)")
        database.execSQL("CREATE INDEX IF NOT EXISTS `index_transaction_new_creditCardId` ON `transaction_new` (`creditCardId`)")
