package lmm.moneylog.ui.features.about
...
fun AboutScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Card(
                ...
                Column {
                    SettingsItem(
                        title = stringResource(R.string.settings_about_summary),
                    ...
                    SettingsItem(
                        ...
                        description = stringResource(R.string.settings_about_privacy),
                    ...
                    SettingsItem(
                        ...
                        description = stringResource(R.string.settings_about_license),
    ...
    if (showSummaryDialog) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.settings_about_summary_dialog_title)) },
            text = { Text(stringResource(R.string.settings_about_summary_desc)) },
            confirmButton = {
